...
"}")
        ...
        self.btnRosto = QtWidgets.QPushButton(Cadastro)
        self.btnRosto.setEnabled(True)
        self.btnRosto.setMinimumSize(QtCore.QSize(290, 40))
        self.btnRosto.setMaximumSize(QtCore.QSize(290, 40))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.btnRosto.setFont(font)
        self.btnRosto.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnRosto.setStyleSheet("*{border-radius: 5px;\n"
"border-width: 1px;\n"
"border-style: solid;\n"
"border-color: #DADADA;\n"
...
"}\n"
"")
        self.btnRosto.setObjectName("btnRosto")
        self.verticalLayout.addWidget(self.btnRosto)
        self.btnConfirmar = QtWidgets.QPushButton(Cadastro)
        self.btnConfirmar.setEnabled(True)
        self.btnConfirmar.setMinimumSize(QtCore.QSize(100, 40))
        font = QtGui.QFont()
        font.setPointSize(14)
...
"")
    ...
    def retranslateUi(self, Cadastro):
        ...
        self.btnRosto.setText(_translate("Cadastro", "Cadastrar rosto"))
        self.btnConfirmar.setText(_translate("Cadastro", "Confirmar"))
